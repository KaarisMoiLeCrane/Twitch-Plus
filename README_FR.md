...
<h3 align="center">Twitch Plus</h3>
  ...
  <p align="center">
    Extension Chrome pour améliorer le Site Twitch.
    <br />
    <a href="https://github.com/KaarisMoiLeCrane/Twitch-Plus"><strong>Explore les docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/KaarisMoiLeCrane/Twitch-Plus">Voir Démo</a>
    ·
    <a href="https://github.com/KaarisMoiLeCrane/Twitch-Plus/issues">Signaler un Bug</a>
    ·
    <a href="https://github.com/KaarisMoiLeCrane/Twitch-Plus/issues">Demander une Fonctionnalité</a>
  </p>
</div>

> You don't understand french ? See [*READ-ME* in english](./README.md) !

<!--
<h1 align="center">Le site vient/est entrain de subir une refonte graphique pouvant causer le non fonctionnement de l'extension. Tout remarche mais je reste à jour au niveau des modifications sur Twitch.</h1>
-->

<h2 align="center">Si un bug survient, il suffit parfois de rafraîchir la page pour le résoudre (pour le moment). Des erreurs peuvent survenir, il faut les ignorer.</h2>
...
Extension web (chromium) pour améliorer le Site Twitch.
...
- [x] FAIRE UN LOGO
- [x] Rendre les VODs et les Moments forts accessibles gratuitement et sans compte.
- [ ] Nettoyer le code

Consultes les [issues ouvertes](https://github.com/KaarisMoiLeCrane/Twitch-Plus/issues) pour une liste complète des fonctionnalités demander (et les problèmes déjà connus).
...
Lien du Projet: [https://github.com/KaarisMoiLeCrane/Twitch-Plus](https://github.com/KaarisMoiLeCrane/Twitch-Plus)
...
- Cette extension n’est pas du tout affiliée à “Twitch.tv”. Je suis juste un gars au hasard qui a fait ce projet.
